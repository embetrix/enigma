		...
		<div class="container" >
			...
			<div class="row ">
				...
				<?php } ?>
					...
					<li class="linkedin" data-toggle="tooltip" data-placement="bottom" title="github"><a href="<?php echo esc_attr($wl_theme_options['whatsapp_link']) ; ?>"><i class="fa fa-github"></i></a></li>
	                <?php } ?>
